// 500 common 5-letter English words used as the daily-answer pool.
// Extend freely — game accepts any 5-letter input regardless of this list.
...
export const EN_WORDS: string[] = [
  ...
  "house","human","hurry","ideal","image","index","inner","input","issue","japan",
  ...
  "major","maker","march","maria","match","mayor","meant","media","metal","might",
  ...
  "refer","right","rival","river","roman","rough","round","route","royal","rural",
  ...
  "would","wound","write","wrong","wrote","yield","young","youth","zebra","azure",
  "amber","alpha","aloud","amaze","amend","amuse","ankle","apron","arbor","ardor",
];
